...
public sealed class AnyObjectReader : JsonReader<object> {
  ...
  public static object Read(ref System.Text.Json.Utf8JsonReader reader, System.Text.Json.JsonSerializerOptions options, bool allowNullInArrays = true, bool allowNullAsPropertyValue = true);
